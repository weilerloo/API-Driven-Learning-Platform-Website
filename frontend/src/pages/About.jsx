...
export default function About() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 w-full h-screen overflow-hidden">
      <img
        alt=""
        ...
        className="absolute inset-0 h-screen w-full object-cover object-right md:object-center"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">
            Join thousands of learners around the world. Access expert tutors,
            interactive courses, and hands-on learning experiences.
          </p>
        </div>
