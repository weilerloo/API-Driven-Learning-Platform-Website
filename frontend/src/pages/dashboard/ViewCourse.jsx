...
import { setCourseViewSidebar } from "../../slices/sidebarSlice.ts"
...
export default function ViewCourse() {
  ...
  useEffect(() => {
    (async () => {
      console.log("Fetching course", { courseId, token });
      const courseData = await getFullDetailsOfCourse(courseId, token);
      console.log("API returned:", courseData);

      if (!courseData || !courseData.courseDetails) {
        console.warn("No courseDetails in API response", courseData);
        return;
      }
